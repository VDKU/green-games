...
const item=document.getElementById("trash-item");
const image=document.getElementById("trash-image");
const result=document.getElementById("trash-result");
const scoreText=document.getElementById("trash-score");
const next=document.getElementById("trash-next");
...
let trash=trashItems[current];


item.textContent=trash.item;

image.textContent=trash.emoji;
...
item.textContent="Game Complete!";
