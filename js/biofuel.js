...
options:[
{text:"Traditional fossil jet fuel",points:0},
{text:"Sustainable aviation fuel (biofuel)",points:3},
{text:"More fuel consumption",points:0}
]
},
...
options:[
{text:"Driving alone",points:0},
{text:"Cycling",points:3},
{text:"Large fuel vehicle",points:0}
]
},
...
options:[
{text:"Renewable energy",points:3},
{text:"More gasoline",points:0},
{text:"Coal powered vehicles",points:0}
]
},
...
options:[
{text:"Car sharing",points:2},
{text:"Driving alone every trip",points:0},
{text:"Leaving engines running",points:0}
]
}
...
const question=document.getElementById("fuel-question");
const options=document.getElementById("fuel-options");
const result=document.getElementById("fuel-result");
const scoreText=document.getElementById("fuel-score");
const next=document.getElementById("fuel-next");
